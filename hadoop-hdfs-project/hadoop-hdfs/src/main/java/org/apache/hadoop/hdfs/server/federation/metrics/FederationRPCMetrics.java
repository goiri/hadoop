...
public class FederationRPCMetrics implements FederationRPCMBean {
  ...
  @Override
  public int getRpcCallQueue() {
    return rpcServer.getServer().getCallQueueLen();
  }

  @Override
  public int getNumOpenRpcConnections() {
    return rpcServer.getServer().getNumOpenConnections();
  }

  @Override
  public int getNumOpenNamenodeConnections() {
    return rpcServer.getRPCClient().getNumNamenodeClients();
  }

  @Override
  public int getNumOpenNamenodePools() {
    return rpcServer.getRPCClient().getNumNamenodePools();
  }

  @Override
  public int getHandlerCount() {
    return rpcServer.getHandlerCount();
  }

  @Override
  public int getReaderCount() {
    return rpcServer.getServer().getNumReaders();
  }

  @Override
  public int getReaderQueueSize() {
    return rpcServer.getReaderQueueSize();
  }

  @Override
  public int getHandlerQueueSize() {
    return rpcServer.getHandlerQueueSize();
  }
  ...
  public String getPathStats() {
    return rpcServer.getRPCMonitor().getPathStats().toJSON();
  }

  @Override
  public int getNamenodePoolMinSize() {
    return rpcServer.getRPCClient().getNamenodePoolMinSize();
  }

  @Override
  public int getNamenodePoolMaxSize() {
    return rpcServer.getRPCClient().getNamenodePoolMaxSize();
  }
}
