...
public interface FederationRPCMBean {
  ...
  int getNumOpenRpcConnections();

  int getNumOpenNamenodeConnections();

  int getNumOpenNamenodePools();

  int getHandlerCount();

  int getHandlerQueueSize();
  ...
  int getNamenodePoolMinSize();

  int getNamenodePoolMaxSize();
}
