...
public interface FederationRouterStateStore {
   ...
   */
  GetRouterRegistrationResponse getRouterRegistration(
   ...
   */
  GetRouterRegistrationsResponse getRouterRegistrations(
   ...
   * @throws IOException Throws exception if unable to query the data store
   */
  RouterHeartbeatResponse routerHeartbeat(RouterHeartbeatRequest request)
      throws IOException;
}
