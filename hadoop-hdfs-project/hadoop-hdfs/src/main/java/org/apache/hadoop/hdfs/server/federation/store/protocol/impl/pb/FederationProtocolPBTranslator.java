 ...
 */
public class FederationProtocolPBTranslator<P extends GeneratedMessage, B extends Builder, T extends MessageOrBuilder> {
  ...
  public void setProto(Object p) {
    if (protoClass.isInstance(p)) {
      ...
      throw new IllegalArgumentException(
          "Unable to decode proto type - " + p.getClass().getName());
    }
  }
