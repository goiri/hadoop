...
public class GetRouterRegistrationRequestPBImpl
    extends GetRouterRegistrationRequest {

  private FederationProtocolPBTranslator<GetRouterRegistrationRequestProto,
  GetRouterRegistrationRequestProto.Builder,
  GetRouterRegistrationRequestProtoOrBuilder> translator =
  ...
  public void setRouterId(String router) {
    this.translator.getBuilder().setRouterId(router);
  }
}