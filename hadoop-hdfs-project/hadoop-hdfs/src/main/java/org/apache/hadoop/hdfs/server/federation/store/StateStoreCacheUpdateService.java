...
/**
 * Service to periodically update the {@link FederationStateStoreService}
...
public class StateStoreCacheUpdateService extends PeriodicService {
  private static final Log LOG =
      LogFactory.getLog(StateStoreCacheUpdateService.class);
   ...
   */
  public StateStoreCacheUpdateService(FederationStateStoreService stateStore) {
    super(StateStoreCacheUpdateService.class.getName());
