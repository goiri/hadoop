...
public abstract class RouterState extends BaseRecord {
  ...
  public static RouterState newInstance(String addr, long startTime,
    ...
    RouterState record =
        FederationProtocolFactory.newInstance(RouterState.class);
    record.setDateStarted(startTime);
    record.setAddress(addr);
    record.setStatus(status);
    record.setCompileInfo(FederationUtil.getCompileInfo());
    record.setBuildVersion(FederationUtil.getCompiledDate());
    return record;
  }

  public abstract long getRegistrationTableVersion();

  public abstract void setRegistrationTableVersion(
      long registrationTableVersion);
  ...
  public abstract long getPathLockVersion();

  public abstract void setPathLockVersion(long version);

  public abstract long getFileResolverVersion();

  public abstract void setFileResolverVersion(long version);
  ...
  public String toString() {
    return getAddress() + " -> " + getStatus().toString() + ","
        + getBuildVersion();
  }
