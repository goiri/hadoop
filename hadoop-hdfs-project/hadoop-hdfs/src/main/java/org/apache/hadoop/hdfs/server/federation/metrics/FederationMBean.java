...
public interface FederationMBean {
  ...
  /**
   * Number of nameservices in the state store that have been decommissioned.
   *
   * @return Number of expired name services.
   */
  int getNumDecommissionedNameservices();
  ...
  /**
   * Get the latest state of all rebalancer logs.
   * @return JSON with all of the known reblancer logs.
   */
  String getRebalancerHistory();
